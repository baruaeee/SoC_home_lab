...
#
# Script generated by Vivado on Mon Jul 13 13:33:38 CEST 2026
...
#
# Usage        : zedblp3.sh
#                zedblp3.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                zedblp3.sh [-reset_run]
#                zedblp3.sh [-reset_log]
#                zedblp3.sh [-help]
#
...
#                script (type 'zedblp3.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname xil_defaultlib -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_14 -libname processing_system7_vip_v1_0_16 -libname lib_cdc_v1_0_2 -libname proc_sys_reset_v5_0_13 -libname generic_baseblocks_v2_1_0 -libname fifo_generator_v13_2_8 -libname axi_data_fifo_v2_1_27 -libname axi_register_slice_v2_1_28 -libname axi_protocol_converter_v2_1_28 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_14 processing_system7_vip_v1_0_16 lib_cdc_v1_0_2 proc_sys_reset_v5_0_13 generic_baseblocks_v2_1_0 fifo_generator_v13_2_8 axi_data_fifo_v2_1_27 axi_register_slice_v2_1_28 axi_protocol_converter_v2_1_28)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "zedblp3.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./zedblp3.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../../tdf1lp3.gen/sources_1/bd/zedblp3/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../tdf1lp3.gen/sources_1/bd/zedblp3/ipshared/aed8/hdl" +incdir+"../../../../tdf1lp3.gen/sources_1/bd/zedblp3/ipshared/ec67/hdl" +incdir+"../../../../tdf1lp3.gen/sources_1/bd/zedblp3/ipshared/aed8/hdl" +incdir+"/home/ipad/Vivado/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.zedblp3 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.zedblp3 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log zedblp3_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./zedblp3.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: zedblp3.sh [-help]\n\
Usage: zedblp3.sh [-step]\n\
Usage: zedblp3.sh [-lib_map_path]\n\
Usage: zedblp3.sh [-reset_run]\n\
Usage: zedblp3.sh [-reset_log]\n\
Usage: zedblp3.sh [-keep_index]\n\
Usage: zedblp3.sh [-noclean_files]\n\n\
